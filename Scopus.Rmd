...
#Descriptive statistics
  ...
  *Which fields are co-publishing more?
  *Where is there potential for future growth?
...
```{r}
#format string
query<-"query=SUBJAREA(AGRI)+OR+SUBJAREA(ENVI)+AND+affil(Stony+Brook+University)+srctitle(Ecology+OR+Evolution)"
...
keep<-names(which(table(dat$Author)>1))
