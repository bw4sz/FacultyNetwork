...
jpeg(filename = "Figures/Overall_NetworkIgraph.jpeg",res=300,height=10,width=8,units="in")
plot(g.copy,vertex.size=6,edge.width=width)
dev.off()
...
#reoroder levels
vdat$Class<-factor(vdat$Class,levels=vdat[order(vdat$Between),"Class"])
```
...
ggsave("Figures/OveralMetrics.jpg",dpi=300,height=8,width=10)
...
ggsave("Figures/LinkTime.jpeg",height=7,width=9,dpi=300)
...
ggsave("InteractionsTime.svg",res=300)
