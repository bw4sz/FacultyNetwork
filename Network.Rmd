...
tocompare<-read.table("C:/Users/Ben/Dropbox/FacultyNetwork/ParsedDataID.csv",row.names=NULL,header=T,sep=",",fill=T,nrows=3000000)
...
simpleNetwork(MisLinks,height=500,width=500)
```

```{r,cache=F}
simpleNetwork(MisLinks,height=500,width=700)  %>% saveNetwork(file = 'Net1.html')
```
...
forceNetwork(Links = MisLinks, Nodes = MisNodes, Source = "source",
             ...
             Group = "group", opacity = 0.4,height=300,width=500)
```
